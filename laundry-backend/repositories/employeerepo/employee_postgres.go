...
func NewEmployeeRepo(repo repositories.Repositories) employeePostgresRepository {
	return employeePostgresRepository{repo: repo}
}
...
func (r employeePostgresRepository) Create(employee entities.Employee) error {
	...
	return r.repo.Db.QueryRow(query, employee.OutletID, employee.NIK, employee.Name, employee.Email, employee.Phone, employee.Address, employee.BirthDate, employee.Gender, employee.Position, employee.Salary, employee.JoinDate, employee.Status).Scan(&employee.ID)
}
...
func (r employeePostgresRepository) Update(employee entities.Employee) error {
	...
	_, err := r.repo.Db.Exec(query, employee.OutletID, employee.NIK, employee.Name, employee.Email, employee.Phone, employee.Address, employee.BirthDate, employee.Gender, employee.Position, employee.Salary, employee.JoinDate, employee.Status, employee.ID)
	return err
}
