...
func NewServiceRepo(repo repositories.Repositories) servicePostgresRepository {
...
func (r servicePostgresRepository) Create(service entities.Service) error {
	...
	err := r.repo.Db.QueryRow(query, service.BrandID, service.CategoryID, service.Name, service.Description, service.Satuan, service.Price, service.Unit, service.Estimation).
		Scan(&service.ID)
	if err != nil {
		return err
	}
...
func (r servicePostgresRepository) Update(service entities.Service) error {
	...
	_, err := r.repo.Db.Exec(query, service.BrandID, service.CategoryID, service.Name, service.Description, service.Price, service.Unit, service.Estimation, service.ID)
	return err
}
...
func (r servicePostgresRepository) FindByCategoryID(categoryID int) ([]entities.Service, error) {
	...
	rows, err := r.repo.Db.Query(query, categoryID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
