-- Data contoh untuk testing database sistem laundry - PostgreSQL Version
...
-- Contoh penggunaan function untuk pendaftaran pelanggan baru
-- SELECT * FROM sp_daftar_pelanggan_baru('08567890123', 'Eko Prasetyo', 'eko@email.com', 'Jl. Dahlia No. 50, Jakarta', '1991-07-20', 'L', 1);

-- Contoh penggunaan function untuk mengecek status pelanggan
-- SELECT * FROM sp_cek_status_pelanggan('08123456789');

-- Contoh penggunaan function untuk mencatat presensi
-- SELECT sp_catat_presensi('1122334455667788', 1, '2023-06-06', '08:00:00', '/images/presensi/1_20230606_masuk.jpg', 'hadir', NULL);

-- Contoh penggunaan function untuk mencatat waktu keluar
-- SELECT sp_catat_keluar('1122334455667788', '2023-06-06', '17:00:00', '/images/presensi/1_20230606_keluar.jpg');